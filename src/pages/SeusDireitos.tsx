...
const rights = [
    {
        ...
        action: 'Como exercer: envie e-mail para suporte@sulmotors.com.br com o assunto "Acesso aos meus dados". Responderemos em até 15 dias úteis.',
    },
    {
        id: '02',
        ...
        action: 'Como exercer: acesse as configurações do seu perfil para atualizar seus dados diretamente, ou entre em contato pelo e-mail suporte@sulmotors.com.br.',
    },
    {
        id: '03',
        ...
        action: 'Como exercer: envie e-mail para suporte@sulmotors.com.br com o assunto "Eliminação de dados". Processaremos sua solicitação em até 15 dias úteis, salvo obrigação legal de retenção.',
    },
    {
        id: '04',
        ...
        action: 'Como exercer: envie e-mail para suporte@sulmotors.com.br com o assunto "Portabilidade de dados". Forneceremos os dados em formato JSON ou CSV.',
    },
    {
        id: '05',
        ...
        action: 'Como exercer: envie e-mail para suporte@sulmotors.com.br com o assunto "Revogar consentimento e excluir dados". Processaremos em até 15 dias úteis.',
    },
    {
        id: '06',
    ...
    },
    {
        ...
        action: 'Como exercer: envie e-mail para suporte@sulmotors.com.br com o assunto "Revogar consentimento" ou ajuste suas preferências nas configurações da conta.',
    },
    {
        id: '08',
        ...
        action: 'Como exercer: envie e-mail para suporte@sulmotors.com.br com o assunto "Oposição ao tratamento de dados", descrevendo os dados e o motivo da oposição.',
    },
    {
        id: '09',
