        ...
        <div className="min-h-screen bg-zinc-950 flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
                ...
                <div className="absolute bottom-12 left-12 right-12">
                    ...
                    <h2 className="text-3xl font-black text-white leading-tight mb-3">
                        O marketplace automotivo
                        <span className="text-brand-400"> mais moderno</span> do Brasil.
                    </h2>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12">
                ...
                >
                    ...
                    {/* Toggle */}
                    <div className="flex items-center gap-2 p-1 bg-zinc-900 border border-white/8 rounded-xl mb-8">
                        <button
                            onClick={() => setIsLogin(true)}
                            className={`flex-1 py-2.5 text-sm font-bold rounded-lg transition-all ${isLogin
                                ? 'bg-brand-400 text-zinc-950 shadow-lg'
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-zinc-500 text-sm">
                            {isLogin
                                ? 'Entre para gerenciar seus anúncios e favoritos'
                                : 'Comece a anunciar seus veículos gratuitamente'
                            }
                        </p>
                    </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-10 pr-4 py-3.5 bg-zinc-900 border border-white/10 focus:border-brand-400/60 rounded-xl text-white placeholder-zinc-600 text-sm outline-none transition-all"
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-12 py-3.5 bg-zinc-900 border border-white/10 focus:border-brand-400/60 rounded-xl text-white placeholder-zinc-600 text-sm outline-none transition-all"
                                    placeholder="••••••••"
                                    minLength={6}
                                />
                                <button
